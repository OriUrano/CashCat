...
<div class="min-h-screen bg-gradient-to-br from-purple-500 to-pink-500 p-4">
	<div class="max-w-md mx-auto">
		<header class="text-center mb-8">
			<h1 class="text-4xl font-bold text-white mb-2">💳 CashCat</h1>
		...
		{:else}
			<div class="bg-white rounded-2xl p-6 shadow-xl mb-6">
				<h2 class="text-xl font-bold text-gray-800 mb-4">💰 Best Cash Back</h2>
				<div class="space-y-3">
					{#each $recommendations as rec}
						<div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
							<div class="flex items-center space-x-3">
								<span class="text-2xl">
									{CASH_BACK_CATEGORIES.find(cat => cat.value === rec.category)?.icon || '💳'}
								</span>
								<div>
